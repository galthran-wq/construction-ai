...
class FacadeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # instance_seg = np.array(Image.open(
        #     converted_instance_labels_base_path / self._filename_to_file(self.idx2filename[idx], is_label=True)
        # ))
        # class_id_map = np.array(Image.open(
        #     converted_class_labels_base_path / self._filename_to_file(self.idx2filename[idx], is_label=True)
        # )
